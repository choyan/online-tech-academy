...
<html class="no-js" lang="">
    ...
    <body class="category-view">
        ...
        <div class="container">
            <div class="row">
                <?php 
                    $cat_name = $con->query("SELECT name FROM course_subcategories WHERE id = $cat")->fetch_object()->name;
                ?>
                <div class="sort-type">
                    Sub-Categories
                </div>
                ...
                <?php 
                    $course_list = $con->query("SELECT LEFT(course_description, 130), id, course_title, banner_img, user_id, published FROM course_info WHERE course_sub_category = '$cat_id' AND status=1");
