        ...
        <div class="row">
            <div class="grid-10 push-1">
                ...
                <div class="section info">
                    <div class="row">
                        <div class="grid-4">
                            ...
                            <?php 
                                $check_instructor = $con->query("SELECT * FROM instructor WHERE user_id = '$student_id'");
                                if((mysqli_num_rows($check_instructor)  == 0) && ($user_id == $student_id)) {
                                    echo "<a href='apply-as-instructor.php' class='button button-small'>Apply as Instructor</a>";
                                }
                                if(($user_id == $student_id) || (is_admin($con, $user_id) == 1)) {
                                    echo "<a href='edit-profile.php' class='button button-small'>Edit Profile</a>";
                                }
                             ?>
                        ...
                        <div class="grid-8">
                            <ul class="list-group user-info">
                                ...
                                <li class="list-group-item"><i class="fa fa-address-card-o" aria-hidden="true"></i> <?php echo $user_info['address'] ?>
                                </li>
                                <li class="list-group-item"><i class="fa fa-phone"></i> <?php echo $user_info['phone'] ?> </li>
                                <li class="list-group-item"><i class="fa fa-envelope"></i> <?php echo $user_info['email'] ?>
                                </li>
                            </ul>
                ...
                <div class="section course">
                    <span class="h3">Purchased Courses:</span>
                    <table class="pure-table pure-table-striped">
                            ...
                            <tr>
                                ...
                                <?php 
                                    if(is_admin($con, $user_id) == 1) {
                                        echo "<th class='text-center'>Cancel Purchase</th>";
                                    }
                                ?>
                            </tr>
                        </thead>
                        <tbody>
                            <?php 
                                $student_courses = $con->query("SELECT * FROM student_courses WHERE user_id = '$student_id'");
                                while($row = $student_courses->fetch_array()) {
                            ?>
                            <tr>
                                <td>
                                    <?php 
                                ...
                                <td>
                                    <?php 
                                        $date = date_create($row['date_taken']);
                                ...
                                <?php 
                                    if(is_admin($con, $user_id) == 1) {
                                        echo "<td class='text-center'><a href='cancel-purchase.php?id=$course_id' class='delete'><i class='fa fa-times'></i></a></td>";
                                    }
                                ?>
                            </tr>
                            <?php 
